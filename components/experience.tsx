...
const chapters = [
 ...
 {number:'03',label:'КАЖДЫЙ ХОД МЕНЯЕТ ДИАЛОГ',title:'Слушайте. Отвечайте. Наблюдайте.',description:'Выберите реплику, напишите ответ или нажмите микрофон и говорите. Соперник озвучивает ответ, а шкала напряжённости показывает, как меняется атмосфера разговора.',icon:Activity},
 {number:'04',label:'ПРАКТИКА БЕЗ СТРАХА ОШИБКИ',title:'Не идеальный ответ. Ваш следующий шаг.',description:'После шести этапов разбор покажет сильные решения и точки роста. В настройках доступны тёмная тема, звуки, автоозвучивание, спокойный режим и подключение своего API-ключа OpenAI.',icon:ShieldCheck}
];
